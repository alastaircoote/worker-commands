...
function transformOption(value) {
    return __awaiter(this, void 0, void 0, function () {
        var match, arrayBuffer_1, base64URL;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (!(value.from === "command")) return [3 /*break*/, 2];
                    return [4 /*yield*/, fireCommand({
                            command: value.command,
                            options: value.options
                        })];
                case 1: return [2 /*return*/, _a.sent()];
                case 2:
                    if (!(value.from === "cache")) return [3 /*break*/, 6];
                    return [4 /*yield*/, caches.match(value.url)];
                case 3:
                    match = _a.sent();
                    if (!match) {
...
function showNotification(options) {
    return __awaiter(this, void 0, void 0, function () {
        var title, events, body, icon, badge, image, nonTitleOptions, _a, transformedIcon, transformedBadge, transformedImage, transformedBody, finalOptions, finalTitle;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    title = options.title, events = options.events, body = options.body, icon = options.icon, badge = options.badge, image = options.image, nonTitleOptions = __rest(options, ["title", "events", "body", "icon", "badge", "image"]);
                ...
                case 1:
                    _a = _b.sent(), transformedIcon = _a[0], transformedBadge = _a[1], transformedImage = _a[2], transformedBody = _a[3];
                    finalOptions = Object.assign({}, nonTitleOptions, {
                        icon: transformedIcon,
                        image: transformedImage,
                        badge: transformedBadge,
                        body: transformedBody
                    });
                    return [4 /*yield*/, transformOption(title)];
                case 2:
                    finalTitle = _b.sent();
                    if (!finalTitle) {
                    ...
                    return [4 /*yield*/, self.registration.showNotification(finalTitle, finalOptions)];
                case 3:
                    _b.sent();
                    return [2 /*return*/];
            }
                ...
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 1:
                                json = _a.sent();
                                if (!(json.data && json.data.payload)) return [3 /*break*/, 2];
                            ...
                            case 2:
                                if (!(json.notification &&
                                    ...
                                    !json.data.__workerCommandPayload)) return [3 /*break*/, 4];
                            ...
                            case 3:
                                ...
                                return [2 /*return*/, true];
                            case 4:
                                payload = json.__workerCommandPayload;
                            ...
                            case 5:
                                _a.trys.push([5, 7, , 8]);
                                return [4 /*yield*/, fireCommand(payload)];
                            case 6:
                                _a.sent();
                                return [3 /*break*/, 8];
                            case 7:
...
function ifClient(ifStatement, event) {
    return __awaiter(this, void 0, void 0, function () {
        var clients, check, existing;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
...
export { setup$7 as setup, fireCommand, registerCommand, addListener, removeListener, sendClient as sendCommand };
